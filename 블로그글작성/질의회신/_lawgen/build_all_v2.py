...
# 내용 스캔 태그맵(구체어 먼저). 폐기물+대기·수질·소음·악취·영향평가 전 분야.
_TAGMAP=[
 # 매체·분야
 ("전략환경영향평가","전략환경영향평가"),("소규모 환경영향평가","소규모환경영향평가"),("환경영향평가","환경영향평가"),
 ("사후환경영향조사","사후환경영향조사"),("협의","협의절차"),("스코핑","스코핑"),
 ("대기오염물질","대기오염물질"),("대기배출시설","대기배출시설"),("비산먼지","비산먼지"),("악취","악취"),("복합악취","복합악취"),
 ("수질오염","수질오염"),("폐수배출시설","폐수배출시설"),("폐수","폐수"),("특정수질유해물질","특정수질유해물질"),
 ("소음","소음진동"),("진동","소음진동"),("생활소음","생활소음"),
 # 폐기물 종류
 ("폐수처리오니","폐수처리오니"),("하수오니","하수오니"),("유기성오니","유기성오니"),("무기성오니","무기성오니"),("오니","오니"),
 ("고로슬래그","고로슬래그"),("제강슬래그","제강슬래그"),("슬래그","슬래그"),("석탄재","석탄재"),("분진","분진"),
 ("폐황산","폐황산"),("폐산","폐산"),("폐알칼리","폐알칼리"),("폐유","폐유"),("폐합성수지","폐합성수지"),
 ("폐전선","폐전선"),("폐축전지","폐축전지"),("의료폐기물","의료폐기물"),("건설폐기물","건설폐기물"),
 ("지정폐기물","지정폐기물"),("사업장폐기물","사업장폐기물"),("생활폐기물","생활폐기물"),("음식물","음식물류폐기물"),
 ("고형연료","고형연료제품"),("부숙토","부숙토"),("성토재","성토재"),("순환골재","순환골재"),
 # 공정·행위
 ("수집·운반","수집운반"),("수집운반","수집운반"),("파쇄","파쇄"),("분쇄","분쇄"),("탈수","탈수"),("건조","건조"),
 ("세척","세척"),("선별","선별"),("용융","용융"),("소각","소각"),("매립","매립"),("보관","폐기물보관"),
 # 허가·신고
 ("종합재활용업","종합재활용업"),("중간재활용업","중간재활용업"),("재활용업","폐기물재활용업"),
 ("변경허가","변경허가"),("변경신고","변경신고"),("재활용","폐기물재활용"),("처리업허가","폐기물처리업허가"),
 ("사업계획서","폐기물처리사업계획서"),("적합판정","적합판정"),
 # 법쟁점
 ("폐기물 여부","폐기물해당여부"),("제품인","제품인정"),("재활용유형","재활용유형"),("재활용기준","재활용기준"),
]
def tags_base(subj,a,extra):
    t=["질의회신","환경인허가","인허가서대리"]+list(extra)
    text=subj+" "+a
    def add(x):
        if x and x not in t: t.append(x)
    for m in sorted(set(re.findall(r'R-?\d(?:-\d)?',text)),key=len,reverse=True): add(m)
    for k,tag in _TAGMAP:
        if k in text: add(tag)
    return t[:22]
