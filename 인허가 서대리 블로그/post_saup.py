# -*- coding: utf-8 -*-
"""사업장폐기물 질의회신을 인허가 서대리 블로그에 올린다.

  START   시작 인덱스(생략하면 _게시상태_사업장.json 의 next_index)
  COUNT   올릴 건수(기본 10)
...
SRC = os.path.join(HERE, "posts_사업장폐기물.json")
STATE = os.path.join(HERE, "_게시상태_사업장.json")
...
st = {"source": "사업장폐기물 질의·회신 사례집", "total": len(ALL),
